    ...
    assert.deepEqual(
      ...
      minify(`
        <div class={{-css-blocks 0 1 "${defaultBlock.guid}" null 1 0 ":scope" 1 1 0}}>
          ...
          <span class={{-css-blocks 0 3 "${defaultBlock.guid}" null "${headerBlock.guid}" null "${typographyBlock.guid}" null 6 0 ".world" 1 ".emphasis" 2 ".underline" 0 ".world[thick]" 1 ".emphasis[style=bold]" 1 ".emphasis[style=italic]" 5 1 1 1 2 3 isWorld 1 0 0 2 (eq isThick 1) 1 3 4 1 textStyle "bold" 1 4 "italic" 1 5}}>World</span>!</h1>
  ...
  it("rewrites styles with the style-of helper", async function() {
    ...
    assert.deepEqual(
      ...
      minify(`
        <div class={{-css-blocks 0 1 "${defaultBlock.guid}" null 1 0 ":scope" 1 1 0}}>
          <h1 class={{-css-blocks 0 1 "${headerBlock.guid}" null 1 0 ":scope" 1 1 0}}>Hello,
          <World cssClass={{-css-blocks 0 2 "${defaultBlock.guid}" null "${headerBlock.guid}" null 5 0 ".world" 1 ".emphasis" 0 ".world[thick]" 1 ".emphasis[style=bold]" 1 ".emphasis[style=italic]" 4 1 0 1 1 1 2 4 1 (textStyle) "bold" 1 3 "italic" 1 4}} />!</h1>
        </div>
      `));
    let analysis = result.analysis.serialize();
    assert.deepEqual(Object.keys(analysis.blocks).length, 3);
    ...
    assert.deepEqual(
      ...
      <div class={{-css-blocks 0 1 "${defaultBlock.guid}" null 1 0 ":scope" 1 1 0}}>
        <h1 class={{-css-blocks 0 1 "${headerBlock.guid}" null 1 0 ":scope" 1 1 0}}>Hello,
          {{yield (hash
            classnames=(hash
              action=(-css-blocks 0 2 "${defaultBlock.guid}" null "${headerBlock.guid}" null 5 0 ".world" 1 ".emphasis" 0 ".world[thick]" 1 ".emphasis[style=bold]" 1 ".emphasis[style=italic]" 4 1 0 1 1 2 isThick 1 2 4 1 (textStyle) "bold" 1 3 "italic" 1 4)))}}
        </h1>
      </div>
      `));
    let analysis = result.analysis.serialize();
