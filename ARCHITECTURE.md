...
You can read more about `Block` objects and their associated APIs in the [Block Object README](https://github.com/css-blocks/css-blocks/tree/master/packages/css-blocks/src/Block/README.md).
...
You can read more about `Analyzer`s and their associated APIs in the [Analyzer README](https://github.com/css-blocks/css-blocks/tree/master/packages/css-blocks/src/TemplateAnalysis/README.md).
...
The [`BlockCompiler`](https://github.com/css-blocks/css-blocks/tree/master/packages/css-blocks/src/BlockCompiler) is responsible for taking in a `Block` object, and emitting a transformed PostCSS root node with the rewritten classes.
...
> Note: BEM is the default output mode for css-blocks – and currently the only output mode – but [other output modes](https://github.com/css-blocks/css-blocks/tree/master/packages/css-blocks/src/OutputMode.ts) for css-blocks may be added in the future.
...
[PROJECT_HOME]: https://github.com/css-blocks/css-blocks
[CORE]: https://github.com/css-blocks/css-blocks/tree/docs/packages/css-blocks
[RUNTIME]: https://github.com/css-blocks/css-blocks/tree/docs/packages/runtime
[OPTICSS]: https://github.com/css-blocks/opticss
[WEBPACK]: https://github.com/css-blocks/css-blocks/tree/docs/packages/webpack-plugin
[BROCCOLI]: https://github.com/css-blocks/css-blocks/tree/docs/packages/broccoli-css-block
[JSX]: https://github.com/css-blocks/css-blocks/tree/docs/packages/jsx
[GLIMMER]: https://github.com/css-blocks/css-blocks/tree/docs/packages/glimmer-templates

[EMBER_CLI_WEBSITE]: https://github.com/css-blocks/css-blocks/packages/ember-cli
