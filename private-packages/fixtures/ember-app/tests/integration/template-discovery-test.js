...
module("Acceptance | Template Discovery", function(hooks) {
  ...
  test("Eager Engine Block Integration", async function(assert) {
    await visit("/@css-blocks-fixtures/ember-engine");
    assert.equal(currentURL(), "/@css-blocks-fixtures/ember-engine", "Navigated to test case");
  ...
  skip("Lazy Engine Block Integration", async function(assert) {
    await visit("/@css-blocks-fixtures/ember-lazy-engine");
    assert.equal(currentURL(), "/@css-blocks-fixtures/ember-lazy-engine", "Navigated to test case");
